...
def part1(lstLine):
    ...
    for l in range(0,len(lstLine)):
       n = int(lstLine[l])
       ch = int(lstLine[(l+1) % len(lstLine)])
       # print('[{}]\tn {}\tch {}'.format(l, n, ch))
       if n == ch:
           sum += n
    return sum
...
def part2(lstLine):
    ...
    for l in range(0,len(lstLine)):
       n = int(lstLine[l])
       ch = int(lstLine[int(l + (circ / 2)) % circ])
       # print('[{}]\tn {}\tch {}'.format(l, n, ch))
       if n == ch:
           sum += n
    return sum
...
def main():
    ...
    print('Part 1: sum = {}'.format(part1(input)))
    print('Part 2: sum = {}'.format(part2(input)))
